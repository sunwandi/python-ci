...
#set -x
#获取 token
ans=$(curl -s -X POST -H "Content-Type: application/json" -d '{  "app_key": "8b575101f6504bc6b81865d5baeaf7a4",  "app_secret": "e6137ac7c6dc4f47aec40e834450a1e6"}' "https://open.c.163.com/api/v1/token")
